...
X = data.drop(["BROKERTITLE", "TYPE", "ADDRESS", "STATE", "MAIN_ADDRESS", "ADMINISTRATIVE_AREA_LEVEL_2", "LOCALITY","SUBLOCALITY", "STREET_NAME","LONG_NAME","FORMATTED_ADDRESS"], axis=1)
y = data["TYPE"]
...
test_ids = test_data["MAIN_ADDRESS"]  # Save IDs for reference if needed
test_data = test_data.drop(["BROKERTITLE", "ADDRESS", "STATE", "MAIN_ADDRESS", "ADMINISTRATIVE_AREA_LEVEL_2", "LOCALITY","SUBLOCALITY", "STREET_NAME","LONG_NAME","FORMATTED_ADDRESS"], axis=1)
test_features = test_data.drop("TYPE", axis=1)
